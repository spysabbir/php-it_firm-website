                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <img class="hidden img-thumbnail" id="portfolio_new_cover_photo" src="../assets/images/portfolio/<?= spy_sabbir_single_select('portfolios', $_GET['id'])['portfolio_cover_photo'] ?>" alt="blog New Cover Photo" />
                                        <script>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mb-2" type="file" name="portfolio_new_banner_photo" onchange="banner_photo_readURL(this);">
                                        <small>Photo Size 640*520 px</small><br>
                                        <img class="hidden img-thumbnail" id="portfolio_new_banner_photo" src="../assets/images/portfolio/<?= spy_sabbir_single_select('portfolios', $_GET['id'])['portfolio_banner_photo'] ?>" alt="blog New Cover Photo" />
                                        <script>
                                            function banner_photo_readURL(input) {
                                                if (input.files && input.files[0]) {
                                                    var reader = new FileReader();
                                                    reader.onload = function(e) {
