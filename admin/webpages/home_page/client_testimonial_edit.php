                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" name="client_testimonials_old_photo_name" class="form-control" value="<?= spy_sabbir_single_select('client_testimonials', $_GET['id'])['project_logo_img'] ?>">
                                        ...
                                        <img class="hidden img-thumbnail" id="client_testimonials_new_cover_photo" src="../assets/images/client_testimonials/<?= spy_sabbir_single_select('client_testimonials', $_GET['id'])['project_logo_img'] ?>" alt="blog New Cover Photo" />
                                        <script>
