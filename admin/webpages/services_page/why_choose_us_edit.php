                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <img class="hidden img-thumbnail" id="new_why_choose_us_cover_photo" src="../assets/images/choose_us/<?= spy_sabbir_single_select('choose_us', $_GET['id'])['why_choose_us_cover_photo'] ?>" alt="why_choose_us New Cover Photo" />
                                        <script>
