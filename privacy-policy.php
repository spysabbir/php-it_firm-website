        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="privacy_policy_item">
                    ...
                    <p>Last updated: September 20, 2020</p>
                    ...
                    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree
                        ...
                        Privacy Policy has been created with the help of the <a
                            href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Privacy
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;,
                                ...
                                Technology, Jessore, Khulna, Bangladesh.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Spy It Firm, accessible from <a href="spyitfirm.com"
                                    rel="external nofollow noopener" target="_blank">spyitfirm.com</a></p>
                        </li>
                        <li>
                    ...
                    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies
                        ...
                        are deleted as soon as You close your web browser. Learn more about cookies: <a
                            href="https://www.privacypolicies.com/blog/cookies/" target="_blank">What Are
                            Cookies?</a>.</p>
                    ...
                    <ul>
                        <li><strong>To provide and maintain our Service</strong>, including to monitor the usage of
                            our Service.</li>
                        <li><strong>To manage Your Account:</strong> to manage Your registration as a user of the
                            ...
                            of the Service that are available to You as a registered user.</li>
                        <li><strong>For the performance of a contract:</strong> the development, compliance and
                            ...
                            purchased or of any other contract with Us through the Service.</li>
                    ...
                    <p>If you'd like to request more information under the California Shine the Light law, and if
                        you are a California resident, You can contact Us using the contact information provided
                        below.</p>
                    <h3>California Privacy Rights for Minor Users (California Business and Professions Code Section
                        22581)</h3>
                    <p>California Business and Professions Code section 22581 allow California residents under the
                        age of 18 who are registered users of online sites, services or applications to request and
                        obtain removal of content or information they have publicly posted.</p>
                    ...
                    <ul>
                        <li>
                            <p>By email: contact@spyitfirm.com</p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a href="spyitfirm.com"
                                    rel="external nofollow noopener" target="_blank">spyitfirm.com</a></p>
                        </li>
                        <li>
                            <p>By phone number: +880 1878 136530</p>
                        </li>
                        <li>
                            <p>By mail: Jessore, Khulna, Bangladesh</p>
                        </li>
                    </ul>
                </div>
            </div>
